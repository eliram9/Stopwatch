...
$(function () {
    ...
    function addLap() {
        ...
        var myLaps = '<div class="LapTimeDisplay">' + '<div class="LapTimeTitle">' + 'Lap ' + lapNumber + '</div>' + '<div class="LapTime">' + '<span>' + format(timeMinutes) + '</span>' + ':' + '<span>' + format(timeSeconds) + '</span>' + ':' + '<span>' + format(timeMilliseconds) + '</span>' + '</div>';
        '</div>';
